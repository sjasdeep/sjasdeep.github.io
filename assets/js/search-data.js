...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "A showcase of projects from both coursework and research.",
          section: "Navigation",
          handler: () => {
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/JasdeepResume.pdf";
          },
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jasdeeps8", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
